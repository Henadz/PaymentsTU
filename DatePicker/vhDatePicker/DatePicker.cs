...
namespace vhDatePicker
{
    ...
    public class DatePicker : Control, INotifyPropertyChanged
    {
        ...
        public override void OnApplyTemplate()
        {
            ...
            if (grdCalendar != null)
            {
                Calendar calendar = grdCalendar.Children[0] as Calendar;
                if (calendar != null)
                {
	        ...
	        this.Text = startDate.ToString(this.DateFormat); //String.Format(this.DateFormat, startDate);
        }
        #endregion
        ...
        static DatePicker()
        {
            ...
            {
                DefaultValue = Thread.CurrentThread.CurrentUICulture.DateTimeFormat.ShortDatePattern, //DateFormatType.MMMddyyyy,
                PropertyChangedCallback = new PropertyChangedCallback(OnDateFormatChanged), 
                AffectsRender = true
            };
            DateFormatProperty = DependencyProperty.Register("DateFormat", typeof(string), typeof(DatePicker), dateFormatMetadata);
        ...
        private static void OnThemeChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (dp.Template != null)
            {
                ...
                if (grid != null)
                {
                    Calendar cld = grid.Children[0] as Calendar;
                    if (cld != null)
                    {
        ...
        {
            DatePicker dp = o as DatePicker;
            var df = (string)e.NewValue;
			//dp.FormatString = "{0:" + df +"}";
   ...
   //                 break;
   //         }
	        dp.Text = dp.DisplayDate.ToString(df); //String.Format(dp.FormatString, dp.DisplayDate);
        ...
        {
            DatePicker dp = o as DatePicker;
	        dp.Text = ((DateTime) e.NewValue).ToString(dp.DateFormat);//String.Format(dp, e.NewValue);
        ...
        private void ValidateText()
        {
            ...
            if (textbox != null)
            {
	            ...
	            this.Text = this.SelectedDate.ToString(this.DateFormat);
		            //String.Format(this.DateFormat, this.SelectedDate);
