	...
	public abstract class ValidationAttribute : Attribute
	{
		...
		private void SetupResourceAccessor()
		{
			if (this._errorMessageResourceAccessor == null)
			{
				...
				{
					throw new InvalidOperationException("Cannot Set ErrorMessage And Resource");
				}
		...
		private void SetResourceAccessorByPropertyLookup()
		{
			if (this._errorMessageResourceType != null && !string.IsNullOrEmpty(this._errorMessageResourceName))
			{
				...
				if (property.PropertyType != typeof(string))
				{
					throw new InvalidOperationException(
						String.Format(
						CultureInfo.CurrentCulture,
						"Resource Property Not String Type",
						property.Name,
						this._errorMessageResourceType.FullName));
				}
			...
			{
				throw new InvalidOperationException(String.Format(CultureInfo.CurrentCulture, "Need Both Resource Type And Resource Name"));
			}
		}
		...
		protected virtual ValidationResult IsValid(object value, ValidationContext validationContext)
		{
			if (this._hasBaseIsValid)
			{
				...
				throw new NotImplementedException("IsValid Not Implemented");
			}
