...
namespace PaymentsTU.Validation
{
	public sealed class ValidationContext : IServiceProvider
	{
		...
		/// <para>
		/// If the <paramref name="serviceProvider"/> specified implements <see cref="IServiceContainer"/>,
			...
			public void AddService(Type serviceType, ServiceCreatorCallback callback, bool promote)
			{
				...
				else
				{
					lock (this._lock)
					{
						...
						{
							throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, /*Resources.DataAnnotationsResources.ValidationContextServiceContainer_ItemAlreadyExists*/ "Item {0} already exists", serviceType), "serviceType");
						}
